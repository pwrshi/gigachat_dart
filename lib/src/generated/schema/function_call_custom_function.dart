...
/// JSON-объект в котором вы можете явно задать некоторые аргументы указанной функции. Остальные аргументы модель сгенерирует самостоятлеьно.
 @JsonKey(name: 'partial_arguments', includeIfNull: false) FunctionCallCustomFunctionPartialArguments? partialArguments,

    }) = _FunctionCallCustomFunction;

    /// Object construction from a JSON representation
    factory FunctionCallCustomFunction.fromJson(Map<String, dynamic> json) => _$FunctionCallCustomFunctionFromJson(json);
...
'partial_arguments': partialArguments,
    ...
    /// JSON-объект в котором вы можете явно задать некоторые аргументы указанной функции. Остальные аргументы модель сгенерирует самостоятлеьно.
    @freezed
    class FunctionCallCustomFunctionPartialArguments with _$FunctionCallCustomFunctionPartialArguments  {
    ...
    /// Object construction from a JSON representation
    factory FunctionCallCustomFunctionPartialArguments.fromJson(Map<String, dynamic> json) => _$FunctionCallCustomFunctionPartialArgumentsFromJson(json);
