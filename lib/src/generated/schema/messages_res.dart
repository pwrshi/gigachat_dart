...
@JsonKey(includeIfNull: false, unknownEnumValue: JsonKey.nullForUndefinedEnumValue,) MessagesResRole ? role,
...
/// No Description
 @JsonKey(name: 'data_for_context', includeIfNull: false) Context? dataForContext,

    }) = _MessagesRes;

    /// Object construction from a JSON representation
    factory MessagesRes.fromJson(Map<String, dynamic> json) => _$MessagesResFromJson(json);

    /// List of all property names of schema
    static const List<String> propertyNames = ['role','content','data_for_context'];
