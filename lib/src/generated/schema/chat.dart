...
/// 
/// Значение по умолчанию зависит от выбранной модели (поле `model`) и может изменяться с обновлениями модели.
@JsonKey(name: 'repetition_penalty', includeIfNull: false) double ? repetitionPenalty,
...
@JsonKey(name: 'update_interval') @Default(0.0) double  updateInterval,
    ...
    static const List<String> propertyNames = ['model','messages','function_call','functions','temperature','top_p','n','stream','max_tokens','repetition_penalty','update_interval'];
...
@JsonKey(name: 'few_shot_examples', includeIfNull: false) List<ChatFunctionsInnerFewShotExamplesInner> ? fewShotExamples,

/// JSON-объект с описанием параметров, которые может вернуть ваша функция.
 @JsonKey(name: 'return_parameters', includeIfNull: false) ChatFunctionsInnerReturnParameters? returnParameters,

    }) = _ChatFunctionsInner;

    /// Object construction from a JSON representation
    factory ChatFunctionsInner.fromJson(Map<String, dynamic> json) => _$ChatFunctionsInnerFromJson(json);

    /// List of all property names of schema
    static const List<String> propertyNames = ['name','description','parameters','few_shot_examples','return_parameters'];
...
'return_parameters': returnParameters,
    ...
    class ChatFunctionsInnerParameters with _$ChatFunctionsInnerParameters  {
      ...
      const factory ChatFunctionsInnerParameters (
        ) = _ChatFunctionsInnerParameters;

    /// Object construction from a JSON representation
    factory ChatFunctionsInnerParameters.fromJson(Map<String, dynamic> json) => _$ChatFunctionsInnerParametersFromJson(json);
    ...
    /// No Description
    @freezed
    class ChatFunctionsInnerFewShotExamplesInner with _$ChatFunctionsInnerFewShotExamplesInner  {
...
/// Пример заполнения параметров пользовательской функции.
 required ChatFunctionsInnerFewShotExamplesInnerParams params,
    ...
    /// Object construction from a JSON representation
    factory ChatFunctionsInnerFewShotExamplesInner.fromJson(Map<String, dynamic> json) => _$ChatFunctionsInnerFewShotExamplesInnerFromJson(json);
...
'params': params,
    ...
    /// JSON-объект с описанием параметров, которые может вернуть ваша функция.
    @freezed
    class ChatFunctionsInnerReturnParameters with _$ChatFunctionsInnerReturnParameters  {
    ...
    /// Object construction from a JSON representation
    factory ChatFunctionsInnerReturnParameters.fromJson(Map<String, dynamic> json) => _$ChatFunctionsInnerReturnParametersFromJson(json);
    ...
    /// Пример заполнения параметров пользовательской функции.
    @freezed
    class ChatFunctionsInnerFewShotExamplesInnerParams with _$ChatFunctionsInnerFewShotExamplesInnerParams  {
    ...
    /// Object construction from a JSON representation
    factory ChatFunctionsInnerFewShotExamplesInnerParams.fromJson(Map<String, dynamic> json) => _$ChatFunctionsInnerFewShotExamplesInnerParamsFromJson(json);
